...
/*
 * Diffie-Hellman Parameters for PHPRPC. Copyright: Ma Bingyao <andot@ujn.edu.cn> Version: 1.2 LastModified: Apr 12, 2010 This library is free. You can redistribute it and/or modify it under GPL.
 */
class DHParams {
	var $len;
	var $dhParams;
