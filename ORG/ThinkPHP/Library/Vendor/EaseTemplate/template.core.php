<?php
/*
 * Edition:	ET080708 Desc:	Core Engine 3 (Memcache/Compile/Replace) File:	template.core.php Author:	David Meng Site:	http://www.systn.com Email:	mdchinese@gmail.com
 */
error_reporting ( 0 );
