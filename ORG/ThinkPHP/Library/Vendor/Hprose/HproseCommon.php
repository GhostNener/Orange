...
/*
 * integer is_utf8(string $s) if $s is UTF-8 String, return 1 else 0
 */
...
/*
 * integer ustrlen(string $s) $s must be a UTF-8 String, return the Unicode code unit (not code point) length
 */
...
/*
 * bool is_list(array $a) if $a is list, return true else false
 */
...
/*
 * mixed array_ref_search(mixed &$value, array $array) if $value ref in $array, return the index else false
 */
...
/*
 * string spl_object_hash(object $obj) This function returns a unique identifier for the object. This id can be used as a hash key for storing objects or for identifying an object.
 */
