...
class Page {
	 ...
	 *        	分页跳转的参数
	 */
	public function __construct($totalRows, $listRows = 20, $parameter = array(), $defaultpar = true) {
		...
		if($this->nowPage<=1&&(int)$parameter['p']>0){
	 ...
	 * @return string
	 */
	public function show($baseUrl = ACTION_NAME) {
		if (0 == $this->totalRows)
			return '';
			
			/* 生成URL */
		$this->parameter [$this->p] = '[PAGE]';
		$this->url = U ( $baseUrl, $this->parameter ); // $this->url = U(ACTION_NAME, $this->parameter);
		/* 计算分页信息 */
