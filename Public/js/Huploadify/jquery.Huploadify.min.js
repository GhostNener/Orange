    ...
    $.fn.Huploadify = function(opts) {
        ...
        this.each(function() {
            ...
            fileObj = {
                ...
                funDeleteFile: function(index) {
                    for (var i = 0,
                    len = this.fileFilter.length; i < len; i++) {
                ...
                init: function() {
                    ...
                    _this.find('.uploadify-button').on('click',
                    function() {
        ...
        var returnObj = {
            ...
            upload: function(fileIndex) {
                if (fileIndex === '*') {
                    for (var i = 0,
                    len = fileObj.fileFilter.length; i < len; i++) {
            ...
            ennable: function(instanceID) {
                var parent = instanceID ? $('file_upload_' + instanceID + '-button') : $('body');
                parent.find('.uploadify-button').css('background-color', '#707070').on('click',
                function() {
