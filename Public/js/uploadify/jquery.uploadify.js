...
SWFUpload.prototype.initSettings = function() {
    ...
    // Button Settings     this.ensureDefault("button_image_url", "");
this.ensureDefault("button_width", 1);     this.ensureDefault("button_height",
1);     this.ensureDefault("button_text", "");
...
SWFUpload.prototype.fileQueueError = function(file, errorCode, message) {
    file = this.unescapeFilePostParams(file);
    this.queueEvent("file_queue_error_handler", [file, errorCode, onomessage]);
};
            ...
            if ($.inArray('onSelectError', settings.overrideEvents) < 0) {
                ...
                case SWFUpload.QUEUE_ERROR.QUEUE_LIMIT_EXCEEDED:
                    if (settings.queueSizeLimit > errorMsg) {
                        this.queueData.errorMsg += '\n 选定的文件数量超过上传限制 (' + errorMsg + ').';
                    } else {
                        this.queueData.errorMsg += '\n 选定的文件数量超过上传的大小限制 (' + settings.queueSizeLimit + ').';
                    }
                    break;
                ...
                case SWFUpload.QUEUE_ERROR.ZERO_BYTE_FILE:
                    ...
                    break;
                case SWFUpload.QUEUE_ERROR.FILE_EXCEEDS_SIZE_LIMIT:
                    this.queueData.errorMsg += '\n文件 "' + file.name + '" 类型不合法 (' + settings.fileTypeDesc + ').';
                    break;
                }
            }
