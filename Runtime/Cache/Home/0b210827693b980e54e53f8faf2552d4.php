...
<div class="container">
	...
	<form class="form-horizontal" action="" role="form"  method="post" multiple="true" >
		...
		<div class="form-group">
			...
			<div class="col-sm-2">
				<div class="pull-left">
					<a id="refreshadd"  class="btn btn-default" data-toggle="tooltip" data-placement="top" title="刷新地址">
						<span class="glyphicon glyphicon-refresh"></span>
					</a>
					<a href="<?php echo U('User/addaddress');?>" target="_blank" class="btn btn-default" data-toggle="tooltip" data-placement="top" title="添加地址">
