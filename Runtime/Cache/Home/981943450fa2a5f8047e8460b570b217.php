...
<div class="container">
	...
	<form class="form-horizontal" role="form" action="" method="post">
		<div class="form-group">
			<input type="hidden" id="modif" class="form-control "  name="modif" value="<?php echo ($modif); ?>" Readonly>
			<label for="Id" class="col-sm-2 control-label">Id</label>
			<div class="col-sm-10">
				<input type="text" class="form-control " id="Id" placeholder=" Id  " name="Id" value="<?php echo ($model["Id"]); ?>" 
					Readonly></div>
		</div>
		<div class="form-group">
			<label for="Tel" class="col-sm-2 control-label">Tel</label>
			<div class="col-sm-10">
				<input type="text" class="form-control " id="Tel" placeholder=" Tel  "name="Tel" value="<?php echo ($model["Tel"]); ?>" ></div>
		</div>
		<div class="form-group">
			<label for="QQ" class="col-sm-2 control-label">QQ</label>
			<div class="col-sm-10">
				<input type="text" class="form-control " id="QQ" placeholder=" QQ  "name="QQ" value="<?php echo ($model["QQ"]); ?>" ></div>
		</div>
		<div class="form-group">
			<label for="Address" class="col-sm-2 control-label">Address</label>
			<div class="col-sm-10">
				<input type="text" class="form-control " id="Address" placeholder=" Address  "name="Address" value="<?php echo ($model["Address"]); ?>" ></div>
		</div>
		<div class="form-group">
			<label for="IsDefault" class="col-sm-2 control-label">IsDefault</label>
			<div class="col-sm-10">
				<label class="checkbox-inline">
					<input type="checkbox" id="IsDefault" value="1">作为默认地址</label>
			</div>
		</div>
		<div class="form-group">
			<div class="col-sm-offset-2 col-sm-10">
				<button id='addressSubmit' type="button" urlindex="<?php echo U('index');?>" acurl="<?php echo U('saveaddress');?>" class="btn btn-default">保存</button>
